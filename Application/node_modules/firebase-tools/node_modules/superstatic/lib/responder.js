...
Responder.prototype._handle = function (item) {
    ...
    return Promise.reject(new Error(JSON.stringify(item) + " is not a recognized responder directive"));
};
...
Responder.prototype.handleRewrite = function (item) {
    ...
    return Promise.reject(new Error("Unable to find a matching rewriter for " + JSON.stringify(item.rewrite)));
};
